    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
		  ...
		  <!-- Isi-->
			 <h3><center>Laporan Pengajuan Cuti</center></h3>
			 <br>
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover">
					...
					$no = 1;
					$total_semua = 0;
					$stid = oci_parse($koneksi, 'SELECT karyawan.*, atasan.*, pengajuan.* FROM pengajuan 
pengajuan INNER JOIN karyawan karyawan ON pengajuan.id_karyawan = karyawan.id_karyawan 
INNER JOIN atasan atasan ON pengajuan.id_atasan = atasan.id_atasan ORDER BY pengajuan.id_pengajuan ASC');
